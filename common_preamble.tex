...
\usepackage{latexsym}
\usepackage{color}
\usepackage{amsmath,amsfonts,amssymb,amscd,mathrsfs}
...
\usepackage{dashbox}
\usepackage{tikz}
\usetikzlibrary{trees,arrows,decorations.pathmorphing,shapes,backgrounds,positioning,calc,tikzmark,external}
