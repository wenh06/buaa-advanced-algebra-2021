...
% 太麻烦
% 解法一：直接验证$\mathbb{Q}(\sqrt[3]{2})$是对加、减、乘、除封闭。其中对加、减、乘封闭好验证，对除法封闭可以利用待定系数法，假设（$a_1,b_1,c_1$不全为零；$a_2,b_2,c_2$为未知量）
% $$\dfrac{1}{a_1 + b_1\sqrt[3]{2} + c_1\sqrt[3]{4}} = a_2 + b_2\sqrt[3]{2} + c_2\sqrt[3]{4}$$
% 变形为
% $$1 = (a_1 + b_1\sqrt[3]{2} + c_1\sqrt[3]{4})(a_2 + b_2\sqrt[3]{2} + c_2\sqrt[3]{4})$$
% 比较$1, \sqrt[3]{2}, \sqrt[3]{4}$的系数，有
% $$
% \begin{cases}
% 1 = a_1a_2 + 2b_1c_2 + 2c_1b_2 \\
% 0 = a_1b_2 + b_1a_2 + 2c_1c_2 \\
% 0 = a_1c_2 + c_1a_2 + b_1b_2
% \end{cases}
% $$
% 写成矩阵形式为
% $$
...
% \end{pmatrix}
% = \begin{pmatrix}
% a_1 & 2c_1 & 2b_1 \\ b_1 & a_1 & 2c_1 \\ c_1 & b_1 & a_1
% \end{pmatrix}
% \begin{pmatrix}
% a_2 \\ b_2 \\ c_2
% \end{pmatrix}
...
% \begin{align*}
% \begin{pmatrix}[ccc|c]
% a_1 & 2c_1 & 2b_1 & 1 \\ b_1 & a_1 & 2c_1 & 0 \\ c_1 & b_1 & a_1 & 0
% \end{pmatrix}
% \to \begin{pmatrix}[ccc|c]
% 1 & 2c_1/a_1 & 2b_1/a_1 & 1/a_1 \\ 0 & a_1^2-2b_1c_1 & 2a_1c_1-2b_1^2 & -b_1 \\ 0 & a_1b_1-2c_1^2 & a_1^2-2c_1b_1 & -c_1
% \end{pmatrix}
% \end{align*}
% $a_1^2-2b_1c_1$, $a_1b_1-2c_1^2$不能同时为零，否则有$b_1 \neq 0, c_1 \neq 0, 2c_1^3 = b_1^3$，在$\mathbb{Q}$中不可能成立。若$a_1^2-2b_1c_1\neq 0$，则上述增广矩阵能化为
% $$\begin{pmatrix}[ccc|c]
% 1 & 2c_1/a_1 & 2b_1/a_1 & 1/a_1 \\ 0 & 1 & (2a_1c_1-2b_1^2)/(a_1^2-2b_1c_1) & -b_1/(a_1^2-2b_1c_1) \\ 0 & 0 & (a_1^2-2b_1c_1)^2 - (2a_1c_1-2b_1^2)(a_1b_1-2c_1^2) & -c_1(a_1^2-2b_1c_1) + b_1(a_1b_1-2c_1^2)
% \end{pmatrix}$$
