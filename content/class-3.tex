...
关于线性映射$f: A \to B$的核（kernel），像（image）等概念和性质，可以用下面的交换图表总结：

$$
\begin{tikzcd}[row sep = large]
& & {\color{cyan} K'} \arrow[d, "i'"', cyan] \arrow[ld, dashed, "\exists ! j_1"', cyan] \arrow[rd, "f\circ i' = 0"', near start, cyan] & {\color{red} C'} \\
0 \arrow[r] & K \arrow[r, "i", "\ker (f)"'] & A \arrow[r, "f"] \arrow[d, "\bar{p}"'] \arrow[ur, "p'\circ f = 0", near end, red] & B \arrow[r, "p", "\operatorname{coker} (f)"'] \arrow[u, "p'", red] & C \arrow[r] \arrow[lu, dashed, "\exists ! j_2"', red] & 0 \\
& & \operatorname{coker} (i) =: \operatorname{coim} (f) \arrow[r, dashed, "\exists ! \bar{f}"'] \arrow[d] \arrow[ur, dashed, "\exists ! f_1", near start] & \operatorname{im} (f) := \ker (p) \arrow[u, "\bar{i}"'] \\[-3ex]
& & 0 & 0 \arrow[u]
\end{tikzcd}
$$
